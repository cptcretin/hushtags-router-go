...
const routes = [
    ...
    {
        path: 'discover',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_components_components_module_ts"), __webpack_require__.e("default-src_app_include_api-client_api-client_module_ts-src_app_include_google-analytics_goog-77c5e6"), __webpack_require__.e("common"), __webpack_require__.e("src_app_discover_discover_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./discover/discover.module */ 4636)).then(m => m.DiscoverPageModule)
    },
    {
        path: 'menu-modal',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_components_components_module_ts"), __webpack_require__.e("src_app_dialog_menu-modal_menu-modal_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dialog/menu-modal/menu-modal.module */ 5913)).then(m => m.MenuModalPageModule)
    },
    {
        path: 'view',
    ...
    {
        path: 'media-dialog',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_dialog_media-dialog_media-dialog_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dialog/media-dialog/media-dialog.module */ 2653)).then(m => m.MediaDialogPageModule)
    },
    {
        path: 'create-dialog',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_dialog_create-dialog_create-dialog_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dialog/create-dialog/create-dialog.module */ 6170)).then(m => m.CreateDialogPageModule)
    },
    {
        path: 'about',
    ...
    {
        path: 'help',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_components_components_module_ts"), __webpack_require__.e("default-src_app_include_api-client_api-client_module_ts-src_app_include_google-analytics_goog-77c5e6"), __webpack_require__.e("src_app_help_help_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./help/help.module */ 6700)).then(m => m.HelpPageModule)
    },
    {
        path: 'empty-tag-dialog',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_dialog_empty-tag-dialog_empty-tag-dialog_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dialog/empty-tag-dialog/empty-tag-dialog.module */ 2181)).then(m => m.EmptyTagDialogPageModule)
    },
];
...
/* harmony export */   "GoogleAnalyticsSettings": () => (/* binding */ GoogleAnalyticsSettings),
...
GoogleAnalyticsSettings.enabled = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.enableGoogleAnalytics;
GoogleAnalyticsSettings.id = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.googleAnalyticsID;
...
AppSettingsService.propDecorators = {
    browserVer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Output }],
    usingIOS: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Output }],
    usingAndroid: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Output }]
};
AppSettingsService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
