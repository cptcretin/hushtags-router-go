...
let HelpPage = class HelpPage {
    constructor(api, alert, log, ga, gps, dialog, nav, toast, translations) {
        this.api = api;
        this.alert = alert;
        this.log = log;
        this.ga = ga;
    ...
    recordHelpRequest() {
        (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.from)(this.gps.getLocation())
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(pos => this.api.post('/help', {
